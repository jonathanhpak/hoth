    ...
    <div style={{minHeight:"100vh",background:"#07070f",fontFamily:"'Press Start 2P',monospace",overflowX:"hidden"}}>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        /* HOME */
        .home{max-width:100%;width:100%;padding:.9rem 1.2rem;}
        ...
        .nametag{
          font-size:.32rem;background:rgba(7,7,15,.9);
        ...
        .hpbar-lbl{
          font-size:.24rem;color:rgba(200,200,240,.6);
          display:flex;justify-content:space-between;margin-bottom:3px;
        }
        .hpbar-track{height:8px;background:#08081a;border:1px solid rgba(42,42,80,.5);overflow:hidden;}
        ...
        .blog{
          ...
          padding:.45rem .65rem;margin-bottom:.5rem;min-height:80px;
        }
        .blog-t{font-size:.26rem;color:var(--muted);margin-bottom:.25rem;letter-spacing:.06em;}
        .blog-e{font-family:'VT323',monospace;font-size:1.15rem;color:var(--text);line-height:1.5;}
        .blog-e.fresh{color:#fff;}
        .moves-grid{display:grid;grid-template-columns:1fr 1fr;gap:.4rem;margin-bottom:.5rem;}
        .mv{
          background:var(--panel2);border:2px solid var(--border);
          padding:.52rem .46rem;font-family:'Press Start 2P',monospace;
          color:var(--text);box-shadow:2px 2px 0 #000;cursor:pointer;
          display:flex;flex-direction:column;gap:4px;transition:all .1s;text-align:left;
        }
        ...
        .mv-n{font-size:.33rem;}
        .mv-c{font-size:.28rem;color:var(--gold);}
        .mv-d{font-size:.26rem;color:var(--muted);font-family:'VT323',monospace;margin-top:2px;}
        .tp-hint{font-size:.26rem;color:var(--muted);text-align:center;}
        .tp-hint span{color:var(--gold);}
        .revive-btn{
          width:100%;background:#160a00;border:3px solid var(--gold);color:var(--gold);
          padding:.65rem;font-family:'Press Start 2P',monospace;font-size:.38rem;
          box-shadow:3px 3px 0 #000;cursor:pointer;
          display:flex;flex-direction:column;align-items:center;gap:5px;
          transition:all .1s;margin-bottom:.5rem;
        }
        .revive-btn:hover:not(:disabled){background:#201200;}
        .revive-btn:disabled{opacity:.25;cursor:not-allowed;}
        .revive-sub{font-size:.28rem;color:var(--muted);}
        .victory-flash{
          background:#071a07;border:2px solid var(--green);
          padding:.55rem;margin-bottom:.5rem;text-align:center;
          animation:vflash .3s ease;
        }
        @keyframes vflash{0%{transform:scale(.96);opacity:.4}100%{transform:scale(1);opacity:1}}
        .vf-t{font-size:.38rem;color:var(--green);margin-bottom:.28rem;}
        .vf-items{font-family:'VT323',monospace;font-size:1.15rem;color:var(--text);line-height:1.6;}
        .vf-lvl{font-size:.36rem;color:var(--gold);margin-top:.24rem;text-shadow:0 0 8px rgba(245,200,66,.5);}
